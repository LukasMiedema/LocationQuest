...
(0, 'ad4dfd67f1f84c2a8982589b3c8dc544');
...
INSERT INTO LOCATION_GAME.QUEST (quest_id, chapter_id, type, qr_code, required, name, text) VALUES
(0, 0, 'QR_TEXT_FETCH', 'e87c8995-cca5-41d5-828f-d4698ced3845', false, 'How many bananas?', 'Most people say 4 but will you????'),
(1, 0, 'QR_TEXT_FETCH', '2f5ba29d-6ce6-4b63-b060-1f2181d7e6ad', true, 'This requires lots of cookies', 'Yes it does'),
(2, 0, 'QR_TEXT_FETCH', '050d10ef-9940-48f2-9abc-bd0aff022a08', false,	'Got some delicious cookies for ya', 'Im not even trying');
